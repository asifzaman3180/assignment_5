...
/**
 * Centralized configuration class for storing application constants
 * including file paths, messages, and format patterns
 */
public class Constants {
    // File paths
    public static final String EMPLOYEES_FILE_PATH = "employees.txt";
    
    // Date formats (for future use in employee record management)
    ...
    // Employee operation specific messages
